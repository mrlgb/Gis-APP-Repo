...
public class TtPlaceMark {
    ...
    @Generated(hash = 174521121)
    private transient TtPlaceMarkDao myDao;
    @Generated(hash = 1817340625)
    public TtPlaceMark(Long placeMarkId, String name, @NotNull Long trackId, int nr,
