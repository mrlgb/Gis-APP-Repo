...
/**
 * Created by chenchen on 2017/7/29.
 */
public class ToastUtil {
    ...
    public static void showToast(Context context, String s) {
        if (toast == null) {
            ...
            ((TextView) ((LinearLayout) toast.getView()).getChildAt(0)).setTextSize(context.getResources().getDimension(R.dimen.x3));
            toast.show();
    ...
    public static void showToast(Context context, String s, int gravity, int offX, int offY) {
        if (toast == null) {
            toast = Toast.makeText(context.getApplicationContext(), s, Toast.LENGTH_SHORT);
            ((TextView) ((LinearLayout) toast.getView()).getChildAt(0)).setTextSize(1);
